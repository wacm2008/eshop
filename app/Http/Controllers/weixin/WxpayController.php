...
class WxpayController extends Controller
{
    ...
    public function paypay($orderno){
        ...
        $total_fee=1;
        //随机的测试订单号
        $order_id=time().'lorenzobi'.mt_rand(11111,99999);
        //订单信息
        $order_info=[
        ...
        $rs = $this->postXmlCurl($xml, $this->weixin_unifiedorder_url, $useCert = false, $second = 180);
        //dd($rs);
...
//        die;
        ...
        return view('weixin.wxtest',$data);
    }
    ...
    private  function postXmlCurl($xml, $url, $useCert = false, $second = 180)
    {
        $ch = curl_init();
        //设置超时
